...
(function ($) {
    ...
    var methods = {
        init: function (url_or_data_or_function, options) {
            ...
            return this.each(function () {
                if ($(this).data("tokenInputObject") == null)
    ...
    $.TokenList = function (input, url_or_data, settings) {
        ...
        if (!li_data) {
            li_data = hidden_input.attr("pre");
            if (typeof li_data == "string")
                li_data = jQuery.parseJSON(li_data);
            else
                li_data = null;
        }
        ...
        function delete_token(token, dontSetFocus) {
        ...
        function show_dropdown_searching() {
            if (settings.searchingText) {
                dropdown.html("<span class=\"" + settings.classes.searching + "\">" + settings.searchingText + "</span>");
                show_dropdown();
            }
        }
        ...
        function show_dropdown_hint() {
            if (settings.hintText) {
                dropdown.html("<span class=\"" + settings.classes.hint + "\">" + settings.hintText + "</span>");
                show_dropdown();
            }
        }
        ...
        function populate_dropdown(query, results) {
            if (results && results.length) {
                ...
                if (settings.noResultsText) {
                    dropdown.html("<span class=\"" + settings.classes.noResults + "\">" + settings.noResultsText + "</span>");
                    show_dropdown();
                }
            }
        }
        ...
        function do_search() {
            var query = input_box.val().toString();
            ...
            if (cached_results) {
                ...
                if (settings.url) {
                    ...
                    if (settings.extraParam) {
                        for (var i in settings.extraParam) {
                            if (i) {
                                var value = settings.extraParam[i];
                                if (typeof value == "function")
                                    value = value();

                                ajax_params.data[i] = value;
                            }
                        }
                    }
        ...
        if ($.isFunction(settings.onReady)) {
            settings.onReady.call(hidden_input);
        }
    };
